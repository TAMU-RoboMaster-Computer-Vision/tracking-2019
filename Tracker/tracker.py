...
try:
    while True:
        ...
        images = colorized_depth                           # this shows the colorized filter image in with black deadspots
        # images = np.hstack((depth_colormap, filtered_colormap)) # this stacks the depth image and the filtered depth image next to each other
